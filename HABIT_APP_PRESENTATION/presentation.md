# Трекер привычек (/HABIT_APP_PRESENTATION/Habit App)
...
- Стартовый экран с добавленными активностями из JSON файла <br><br>
![Скриншот](./assets/Screenshot_1.png)

- Экран с добавленными комментариями пользователя <br><br>
![Скриншот](./assets/Screenshot_2.png)

- Экран с добавлением активности <br><br>
